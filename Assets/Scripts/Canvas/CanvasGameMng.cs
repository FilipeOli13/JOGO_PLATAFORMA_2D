...
public class CanvasGameMng : MonoBehaviour
{
    ...
    public void FimDeJogo(){
        ...
        SalvarDadosDoLevel();
        StartCoroutine(ExibirTelaFinal());
    }

    private IEnumerator ExibirTelaFinal(){
    ...
    private void SalvarDadosDoLevel(){
        int itensSalvosNoLevel = DBMng.BuscarQtdFrutasLevel(idLevel);
        DefinirMedalhaDoLevel();
        if(totalItensColetados > itensSalvosNoLevel){
